...
class Results(SurrogatePK, Model):
    ...
    result_text = Column(db.String(200), nullable=True, default="Sample pending")
...
class User(UserMixin, SurrogatePK, Model):
    ...
    api_key = db.Column(db.String, unique=True, default=None)
    recovery_key = db.Column(db.String, default=None, nullable=True)
